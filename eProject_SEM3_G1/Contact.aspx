					...
					<div class="contact-us-form">
						...
						<form method="post" id="contact-us">
							<div class="controls controls-row">
							   <input class="span4" type="text" name="name-contact" placeholder="Your Name - Required">
							   <input class="span4" type="text" name="email-contact" placeholder="Your E-Mail - Required">
							</div>
							<div class="controls">
							   <textarea class="span8" name="message-contact" placeholder="You Message..."></textarea>
							</div>
							<div class="controls">
							   <img src="/img/ajax-loader.gif" id="ajaxLoader"/><button type="submit" class="btn btn-primary pull-right">Send It</button>
							</div>
						</form><!--end form-->
